...
urlpatterns = [
    ...
    path('account-details/<int:account_number>/', views.account_details, name="account_details"),
    ...
    path('saving-account-transfer/<int:account_number>/', views.saving_account_transfer, name="saving_account_transfer"),
